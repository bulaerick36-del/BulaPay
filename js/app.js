...
// ==========================================
// MÓDULO DE SOPORTE GLOBAL E INYECTOR DE MODAL (#modal-login-support)
// ==========================================
  ...
  if (!modal) {
    ...
    if (document.body) {
      ...
      document.addEventListener('DOMContentLoaded', function() {
        if (!document.getElementById('modal-login-support')) {
          document.body.appendChild(modal);
        }
      });
    }
...
window.abrirSoporteNativo = function() {
  ...
  setTimeout(function() {
    try {
      ...
      console.warn("Storage u objeto de usuario no disponible (ignorado):", err);
    }
  }, 10);
};
