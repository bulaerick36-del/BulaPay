...
// Purga automática de Service Workers y anuncios demo obsoletos (bulapay-v334)
...
// Registro de Service Worker PWA con Auto-Destrucción y Re-registro Forzoso (bulapay-v334)
if ('serviceWorker' in navigator) {
  const triggerPurge = () => {
